...
algorithms = ['KMeans', 'DBSCAN',
              # 'AffinityPropagation',
              'BIRCH', 'OPTICS', 'Mean Shift', 'AgglomerativeClustering']
# algorithms = ['KMeans']
            ...
            if os.path.isfile(os.path.join(raw_directory_path, filename)):
                ...
                hyperparameter_domains = {
                    ...
                    'AffinityPropagation': {
                        ...
                        'preference': [-0.1, -0.5, 0.1, 0.5,],  # log-scale generated values
                    },
                    'BIRCH': {
                ...
                if algorithm_name == 'KMeans':
                    ...
                    model_final = MeanShift(**ast.literal_eval(best_params))
